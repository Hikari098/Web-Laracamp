                    ...
                    <form action="{{ route('Product.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_produk" name="nama_produk" class="form-control @error('nama_produk') is-invalid @enderror" id="exampleInputEmail1" placeholder="Masukkan Nama Product">
                            </div>
                            @error('nama_produk')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="harga" name="harga" class="form-control @error('harga') is-invalid @enderror" id="exampleInputEmail1" placeholder="Masukkan harga Product">
                            </div>
                            @error('harga')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <textarea @error('deskripsi') is-invalid @enderror class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Enter ..."></textarea>
                                @error('deskripsi')
                                <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </div>
