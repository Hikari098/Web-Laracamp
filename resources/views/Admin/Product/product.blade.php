            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('produk.bodycare')}}" class="btn bg-gradient-blue btn-md">Add Bodycare</a>
                        <a href="{{ route('produk.haircare')}}" class="btn  bg-gradient-cyan btn-md">Add Haircare</a>
